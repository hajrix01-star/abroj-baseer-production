...
export class BaseerPurchaseExpenseDashboard extends Component {
    ...
    get labels() {
        return {
            ...
            count: _t("Documents"), total: _t("Total purchases and expenses"),
            residual: _t("Unpaid balance"), paid: _t("Paid"),
            taxBasis: _t("All amounts include tax"),
            timeline: _t("Monthly movement"), timelineNote: _t("Posted purchase totals and paid amounts"),
            timelineAccessible: _t("Monthly purchases and paid amounts"),
            vendors: _t("Top suppliers"), vendor: _t("Supplier"), categories: _t("Purchase categories"), category: _t("Category"),
            grossAmount: _t("Amount including tax"), salesRatio: _t("Share of approved sales including tax"),
            ratioBasis: _t("Supplier cost including tax ÷ approved sales including tax"),
            categoryNote: _t("Stored spend allocations, grouped by analytic plan and account; missing shares remain unclassified"),
            ratioUnavailable: _t("No approved gross sales were recorded for this period, so purchase-to-sales percentages are unavailable."),
            noVendors: _t("No suppliers in the selected period."), noCategories: _t("No purchase lines in the selected period."),
